...
exports.run = async (client, message, args) => {
  ...
  const Durum = user.presence.status;
            ...
            const durm = (Durum == "online" ? (client.emojis.get('647559700484718593') + "Çevrimiçi") : (Durum == "offline" ? (client.emojis.get('647559700484718593') + "Çevrimdışı") : (Durum == "idle" ? (client.emojis.get('647559700484718593') + "Boşta") : (Durum == "dnd" ? (client.emojis.get('647559700484718593') + "Rahatsız Etmeyin") : ("Bilinmiyor/Bulunamadı.")))))
