...
exports.run = (client, message, args) => {
  if (message.author.id != "727046674006147134") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  message.delete();
  message.reply('Mesajını Şanslı Kişiye Gönderim.')
  const embed = new Discord.RichEmbed()
  .setColor('RANDOM')
  .setTitle(`**Şanslısın Sahibim Seninle Özel Konuşuyor**`)
  .setTimestamp()
